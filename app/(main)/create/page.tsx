...
export default function Page() {
  return (
    <div className="flex flex-col items-center h-full mt-3 sm:ml-44 sm:mt-10">
      <h1 className="text-3xl sm:text-4xl">Unleash Your Creativity!</h1>
      <div className="flex w-full justify-center mt-10 sm:mt-20">
        <div className="flex flex-col justify-start text-center w-1/2 mx-1">
          ...
          <Link href="/create/generate">
            <div className="border border-black rounded-xl mb-2 flex flex-col items-center py-12 hover:bg-select transition-colors">
              <Cog8ToothIcon className="w-20 sm:w-48 mb-4"/>
              <h1>Generate Quiz</h1>
            </div>
          </Link>
          <h4 className="text-xl">Whip up quizzes using our question pool.</h4>
        </div>
        <div className="flex flex-col justify-start text-center w-1/2 mx-1 sm:mr-3">
          <h2 className="text-2xl mb-2">Feeling creative?</h2>
          <Link href="/create/quiz-maker">
            <div className="border border-black rounded-xl mb-2 flex flex-col items-center py-12 hover:bg-select transition-colors">
              <PencilIcon className="w-20 sm:w-48 mb-4"/>
              <h1>Generate Quiz</h1>
            </div>
          </Link>
